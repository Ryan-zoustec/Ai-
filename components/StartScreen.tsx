...
const StartScreen: React.FC<StartScreenProps> = ({ onStart, onLoad }) => {
  ...
  return (
    <div className="ornate-box max-w-4xl mx-auto">
        <div className="ornate-box-inner p-6 md:p-8">
            <div className="text-center">
                <h1 className="text-5xl md:text-6xl font-bold text-cyan-300 mb-4 tracking-wider text-glow">{t(language, 'adventureTitle')}</h1>
                <h2 className="text-2xl md:text-3xl text-slate-300 mb-6">{t(language, 'adventureSubtitle')}</h2>
                <p className="text-slate-400 max-w-3xl mx-auto mb-8">
                    {t(language, 'introText')}
                </p>

                <div className="max-w-md mx-auto mb-8 p-4 sm:p-6 bg-slate-800/50 border border-slate-700 rounded-lg">
                    ...
                    {voiceEnabled && (
                        <div className="transition-all duration-300 space-y-4 animate-fade-in">
                            <div>
                ...
                <div className="flex flex-col items-center gap-4">
                    <button
                        ...
                        className="bg-cyan-600 text-white font-bold py-3 px-8 rounded-lg hover:bg-cyan-500 transition-all duration-300 transform hover:scale-105 shadow-lg shadow-cyan-500/20 text-xl button-glow"
                    >
